<?php $title = "Modification d'un utilisateur"; ?>
...
<main class="mb-4">
    <div class="container px-4 px-lg-5">
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-md-10 col-lg-8 col-xl-7">
                <p>Modification d'un utilisateur
                </p>
                <div class="my-5">
                    <!-- Contact Form -->
                    <form method="post" action="index.php?action=editUsert&id=
                        ...
                        <div class="form-floating">
                            <input class="form-control" id="chapo"
                                   ...
                                   value=<?= htmlspecialchars($user->chapo) ?>
                        ...
                        <div class="form-floating">
                            <textarea class="form-control" id="content"
                                      name="content"
                                      value=<?= htmlspecialchars($user->content) ?>
