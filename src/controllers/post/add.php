...
class AddPost
{
    public function execute(): void
    {
        if (isset($_POST['title']) && isset($_POST['chapo']) && isset($_POST['content'])
            ...
            $postRepository->createPost(htmlspecialchars($_POST['title']),
                htmlspecialchars($_POST['chapo']), htmlspecialchars($_POST['content']),
                htmlspecialchars($_POST['image']), htmlspecialchars($_POST['category']),
